class PerfectSumProblem {
    ...
    public int perfectSum(int arr[], int n, int sum) {
        ...
        // return solveByRecursion(arr,n-1,sum,mod);

        // int[][] dp = new int[n][sum+1];
        // for(int[] row : dp){
        // Arrays.fill(row,-1);
        // }
        // return solveByTopDownDP(arr,n-1,sum,mod,dp);

        // return solveByBottomUpDP(arr,n,sum,mod);

        return solveBySpaceOptimize(arr, n, sum, mod);
    }
}